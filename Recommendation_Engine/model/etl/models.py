...
class DIM_DEVICE_DIRECTORY(Base):
    ...
    SUPPORTS_LTE = Column(Boolean, nullable=True)
    SUPPORTS_VOLTE = Column(Boolean, nullable=True)
    ...
    CAMERA_FLASHLIGHT = Column(Boolean, nullable=True)
    CAMERA_MATRIX = Column(DECIMAL(9, 2), nullable=True)  
    CAMERA_PHOTOSIZE = Column(String(50), nullable=True)  
    FRONTCAM_FLASHLIGHT = Column(Boolean, nullable=True) 
    ...
    SUPPORTS_ESIM = Column(Boolean, nullable=True)  
    SUPPORT_5G = Column(Boolean, nullable=True)
    ...
    DATA_ONLY = Column(Boolean, nullable=True)  
